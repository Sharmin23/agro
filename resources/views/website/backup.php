            ...
            <div class="card-body">
              ...
              <div class="row mb-4">
                <div class="form-outline">
                  ...
                  <input type="text" name="full_name" id="form6Example1" value=" {{ Auth::user()->name }}" class="form-control" disabled>
                </div>
              </div>
              <!-- Text input -->
              <div class="form-outline mb-4">
                <label class="form-label" for="form6Example4">Full Address</label>
                <input name="full_address" type="text" id="form6Example4" class="form-control">
              </div>
              <!-- Email input -->
              <div class="form-outline mb-4">
                <label class="form-label" for="form6Example5">Email</label>
                <input type="email" name="email" value=" {{ Auth::user()->email }}" id="form6Example5" class="form-control" disabled>
              </div>
              <!-- Number input -->
              <div class="form-outline mb-4">
