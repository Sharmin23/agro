            ...
            <div class="card-body">
              ...
              <div class="row mb-4">
                <div class="form-outline">
                  ...
                  <input type="text" value="{{ Auth::user()->name}}" name="full_name" class="form-control" disabled required>
...
<input type="hidden" name="total_amount" value="{{ Cart::getTotal() }}">
              ...
              <div class="form-outline mb-4">
                ...
                <label>Email <span>*</span></label>
                                <input class="form-control" value="{{ Auth::user()->email}}" type="email" name="email" disabled required>
              </div>
              <!-- Email input -->
              <div class="form-outline mb-4">
        ...
        <div class="col-md-4 mb-4">
          ...
          <div class="place_order">
            <button type="subnit" class="btn btn_my w-100" >Place Order</button>
          </div>
        </div>
        </div>
      </form>
