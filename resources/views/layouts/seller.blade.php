			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{ request()->is('admin/agriinfo') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{url('seller/me/allproduct')}}">
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">All Product Information
							</span>
						</a>
					</li>


					<li class="sidebar-item {{ request()->is('seller/me/allcategory') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{url('seller/me/allcategory')}}">
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">All Category
							</span>
						</a>
					</li>
					...
					<li class="sidebar-item {{ request()->is('seller/me/addproduct') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{url('seller/me/addproduct')}}">
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Add New Product
							</span>
						</a>
					</li>

					<li class="sidebar-item {{ request()->is('seller/me/addproduct') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{url('seller/me/addcategory')}}">
							<i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Add New Category
							</span>
						</a>
					</li>
