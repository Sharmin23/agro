...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $alldata = Shipping::orderBy('id','desc')->get();
        return view('admin.order.index',compact('alldata'));
    ...
    public function show($id)
    {
        ...
        foreach($order_detail as $single){
            ...
            $product_name = Project::where('id',$single->product_id)->firstorFail();
        ...
        return view('admin.order.show',compact('shipping_data','order_all_details','order_id'));
    ...
    public function edit($id)
    {
        ...
        return view('admin.order.edit',compact('order_id','shipping_data'));
    }
